        ...
        <?php if(isset($_SESSION['root']) and $_SESSION['root'] == 'admin'): ?>
            <div class="edit">
                <form method="post" action="edit.php" class="form-edit">
                    <br><button type="submit" name="editBtnName" value='Лего: фильм' class="button_edit">
                        Редактирование
                    </button>
                </form>
            </div>
